...
export default function page() {
  return (
    <section className='px-4 md:px-8 py-8 md:py-12 bg-tertiary/25'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-12 px-2 pb-4 md:pb-0'>
            <div className='border rounded-2xl flex items-center justify-center min-h-75 md:min-h-100 bg-black/10'>
                <span className="text-secondary/50 font-medium">Mapa Interactivo</span>
            </div>
            <div className='flex flex-col gap-6 md:gap-8'>
              <div>
                  ...
                  <p className='text-secondary/65 text-pretty text-base md:text-lg mt-2'>
                      ...
                      Despliegue de unidades técmicas en minutos para mitigar fallas catastróficas en la red de seguridad.
                  </p>
              </div>
